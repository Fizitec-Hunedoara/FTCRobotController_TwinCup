...
public class PachetelNouDetectie extends OpenCvPipeline {
    ...
    public Mat processFrame(Mat in) {
        ...
        try {
            ...
            if (CV_detectionType == Parametri.DetectionTypes.DAY_BLUE) {
                scalarLowerHSV = new Scalar(Day_Hlow_Blue, Day_Slow_Blue, Day_Vlow_Blue);
                scalarUpperHSV = new Scalar(Day_Hhigh_Blue, Day_Shigh_Blue, Day_Vhigh_Blue);
            }
            else if(CV_detectionType == Parametri.DetectionTypes.NIGHT_BLUE){
                scalarLowerHSV = new Scalar(Night_Hlow_Blue, Night_Slow_Blue, Night_Vlow_Blue);
                scalarUpperHSV = new Scalar(Night_Hhigh_Blue, Night_Shigh_Blue, Night_Vhigh_Blue);
            }
            else if(CV_detectionType == DetectionTypes.DAY_RED){
                ...
                scalarLowerHSV = new Scalar(Night_Hlow_Red, Night_Slow_Red, Night_Vlow_Red);
                scalarUpperHSV = new Scalar(Night_Hhigh_Red, Night_Shigh_Red, Night_Vhigh_Red);
            }
